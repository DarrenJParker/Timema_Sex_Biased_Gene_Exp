...
write.table(TTT_WB_SB_RBBH_Tbi_sex_bias$table, "TTT_lrt_Tbi_sex_bias_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SB_RBBH_Tce_sex_bias$table, "TTT_lrt_Tce_sex_bias_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SB_RBBH_Tcm_sex_bias$table, "TTT_lrt_Tcm_sex_bias_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SB_RBBH_Tpa_sex_bias$table, "TTT_lrt_Tpa_sex_bias_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SB_RBBH_Tps_sex_bias$table, "TTT_lrt_Tps_sex_bias_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
...
write.table(TTT_WB_SA_RBBH_Tbi_sex_asex$table, "TTT_lrt_Tbi_sex_asex_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SA_RBBH_Tce_sex_asex$table, "TTT_lrt_Tce_sex_asex_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SA_RBBH_Tcm_sex_asex$table, "TTT_lrt_Tcm_sex_asex_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SA_RBBH_Tpa_sex_asex$table, "TTT_lrt_Tpa_sex_asex_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)
write.table(TTT_WB_SA_RBBH_Tps_sex_asex$table, "TTT_lrt_Tps_sex_asex_WB_Vi.csv", sep = ',', quote = FALSE, row.names = FALSE)


########################################################################################################################################################################
####### output session info
print (sessionInfo())
writeLines(capture.output(sessionInfo()), "sex_bias_edgeR_withVIfemales_sessionInfo.txt")
