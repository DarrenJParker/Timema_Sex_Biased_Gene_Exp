##### This script has one sep disp for all comparisons! (the way to do it I reckon)
...
rawdata_Tbi_longest_iso <- read.csv("Data/Read_counts/to_Tte_longest_iso_Arthropoda+Mixed+NOBLASTHIT_K2edge.counts", check.names=FALSE, stringsAsFactors=FALSE)
rawdata_Tce_longest_iso <- read.csv("Data/Read_counts/to_Tms_longest_iso_Arthropoda+Mixed+NOBLASTHIT_K2edge.counts", check.names=FALSE, stringsAsFactors=FALSE)
rawdata_Tcm_longest_iso <- read.csv("Data/Read_counts/to_Tsi_longest_iso_Arthropoda+Mixed+NOBLASTHIT_K2edge.counts", check.names=FALSE, stringsAsFactors=FALSE)
rawdata_Tpa_longest_iso <- read.csv("Data/Read_counts/to_Tge_longest_iso_Arthropoda+Mixed+NOBLASTHIT_K2edge.counts", check.names=FALSE, stringsAsFactors=FALSE)
rawdata_Tps_longest_iso <- read.csv("Data/Read_counts/to_Tdi_longest_iso_Arthropoda+Mixed+NOBLASTHIT_K2edge.counts", check.names=FALSE, stringsAsFactors=FALSE)
...
dir.create("Output")
dir.create("Output/DE_asexual_ref")

setwd("Output/DE_asexual_ref")
...
"Tbi_SF_WB_Md_Re1_toTte","Tbi_SF_WB_Md_Re2_toTte","Tbi_SF_WB_Md_Re3_toTte",
"Tbi_SM_WB_Md_Re1_toTte","Tbi_SM_WB_Md_Re2_toTte","Tbi_SM_WB_Md_Re3_toTte",
"Tte_AF_WB_Vi_Re1_toTte","Tte_AF_WB_Vi_Re2_toTte","Tte_AF_WB_Vi_Re3_toTte"
)], genes=rawdata_Tbi_longest_iso[,1:1])

y_WB_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c(
"Tce_SF_WB_Md_Re1_toTms","Tce_SF_WB_Md_Re2_toTms","Tce_SF_WB_Md_Re3_toTms",
"Tce_SM_WB_Md_Re1_toTms","Tce_SM_WB_Md_Re2_toTms","Tce_SM_WB_Md_Re3_toTms",
"Tms_AF_WB_Vi_Re1_toTms","Tms_AF_WB_Vi_Re2_toTms","Tms_AF_WB_Vi_Re3_toTms"
)], genes=rawdata_Tce_longest_iso[,1:1])

y_WB_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c(
"Tcm_SF_WB_Md_Re1_toTsi","Tcm_SF_WB_Md_Re2_toTsi","Tcm_SF_WB_Md_Re3_toTsi",
"Tcm_SM_WB_Md_Re1_toTsi","Tcm_SM_WB_Md_Re2_toTsi","Tcm_SM_WB_Md_Re3_toTsi",
"Tsi_AF_WB_Vi_Re1_toTsi","Tsi_AF_WB_Vi_Re2_toTsi","Tsi_AF_WB_Vi_Re3_toTsi"
)], genes=rawdata_Tcm_longest_iso[,1:1])

y_WB_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c(
"Tpa_SF_WB_Md_Re1_toTge","Tpa_SF_WB_Md_Re2_toTge","Tpa_SF_WB_Md_Re3_toTge",
"Tpa_SM_WB_Md_Re1_toTge","Tpa_SM_WB_Md_Re2_toTge","Tpa_SM_WB_Md_Re3_toTge",
"Tge_AF_WB_Vi_Re1_toTge","Tge_AF_WB_Vi_Re2_toTge","Tge_AF_WB_Vi_Re3_toTge"
)], genes=rawdata_Tpa_longest_iso[,1:1])

y_WB_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c(
"Tps_SF_WB_Md_Re1_toTdi","Tps_SF_WB_Md_Re2_toTdi","Tps_SF_WB_Md_Re3_toTdi",
"Tps_SM_WB_Md_Re1_toTdi","Tps_SM_WB_Md_Re2_toTdi","Tps_SM_WB_Md_Re3_toTdi",
"Tdi_AF_WB_Vi_Re1_toTdi","Tdi_AF_WB_Vi_Re2_toTdi","Tdi_AF_WB_Vi_Re3_toTdi"
...
"Tbi_SF_RT_Md_Re1_toTte","Tbi_SF_RT_Md_Re2_toTte","Tbi_SF_RT_Md_Re3_toTte",
"Tbi_SM_RT_Md_Re1_toTte","Tbi_SM_RT_Md_Re2_toTte","Tbi_SM_RT_Md_Re3_toTte",
"Tte_AF_RT_Vi_Re1_toTte","Tte_AF_RT_Vi_Re2_toTte","Tte_AF_RT_Vi_Re3_toTte"
)], genes=rawdata_Tbi_longest_iso[,1:1])

y_RT_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c(
"Tce_SF_RT_Md_Re1_toTms","Tce_SF_RT_Md_Re2_toTms","Tce_SF_RT_Md_Re3_toTms",
"Tce_SM_RT_Md_Re1_toTms","Tce_SM_RT_Md_Re2_toTms","Tce_SM_RT_Md_Re3_toTms",
"Tms_AF_RT_Vi_Re1_toTms","Tms_AF_RT_Vi_Re2_toTms","Tms_AF_RT_Vi_Re3_toTms"
)], genes=rawdata_Tce_longest_iso[,1:1])

y_RT_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c(
"Tcm_SF_RT_Md_Re1_toTsi","Tcm_SF_RT_Md_Re2_toTsi","Tcm_SF_RT_Md_Re3_toTsi",
"Tcm_SM_RT_Md_Re1_toTsi","Tcm_SM_RT_Md_Re2_toTsi","Tcm_SM_RT_Md_Re3_toTsi",
"Tsi_AF_RT_Vi_Re1_toTsi","Tsi_AF_RT_Vi_Re2_toTsi","Tsi_AF_RT_Vi_Re3_toTsi"
)], genes=rawdata_Tcm_longest_iso[,1:1])

y_RT_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c(
"Tpa_SF_RT_Md_Re1_toTge","Tpa_SF_RT_Md_Re2_toTge","Tpa_SF_RT_Md_Re3_toTge",
"Tpa_SM_RT_Md_Re1_toTge","Tpa_SM_RT_Md_Re2_toTge","Tpa_SM_RT_Md_Re3_toTge",
"Tge_AF_RT_Vi_Re1_toTge","Tge_AF_RT_Vi_Re2_toTge","Tge_AF_RT_Vi_Re3_toTge"
)], genes=rawdata_Tpa_longest_iso[,1:1])

y_RT_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c(
"Tps_SF_RT_Md_Re1_toTdi","Tps_SF_RT_Md_Re2_toTdi","Tps_SF_RT_Md_Re3_toTdi",
"Tps_SM_RT_Md_Re1_toTdi","Tps_SM_RT_Md_Re2_toTdi","Tps_SM_RT_Md_Re3_toTdi",
"Tdi_AF_RT_Vi_Re1_toTdi","Tdi_AF_RT_Vi_Re2_toTdi","Tdi_AF_RT_Vi_Re3_toTdi"
)], genes=rawdata_Tps_longest_iso[,1:1])
...
"Tbi_SF_LG_Md_Re1_toTte","Tbi_SF_LG_Md_Re2_toTte","Tbi_SF_LG_Md_Re3_toTte",
"Tbi_SM_LG_Md_Re1_toTte","Tbi_SM_LG_Md_Re2_toTte","Tbi_SM_LG_Md_Re3_toTte",
"Tte_AF_LG_Vi_Re1_toTte","Tte_AF_LG_Vi_Re2_toTte","Tte_AF_LG_Vi_Re3_toTte"
)], genes=rawdata_Tbi_longest_iso[,1:1])

y_LG_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c(
"Tce_SF_LG_Md_Re1_toTms","Tce_SF_LG_Md_Re2_toTms","Tce_SF_LG_Md_Re3_toTms",
"Tce_SM_LG_Md_Re1_toTms","Tce_SM_LG_Md_Re2_toTms","Tce_SM_LG_Md_Re3_toTms",
"Tms_AF_LG_Vi_Re1_toTms","Tms_AF_LG_Vi_Re2_toTms","Tms_AF_LG_Vi_Re3_toTms"
)], genes=rawdata_Tce_longest_iso[,1:1])

y_LG_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c(
"Tcm_SF_LG_Md_Re1_toTsi","Tcm_SF_LG_Md_Re2_toTsi","Tcm_SF_LG_Md_Re3_toTsi",
"Tcm_SM_LG_Md_Re1_toTsi","Tcm_SM_LG_Md_Re2_toTsi","Tcm_SM_LG_Md_Re3_toTsi",
"Tsi_AF_LG_Vi_Re1_toTsi","Tsi_AF_LG_Vi_Re2_toTsi","Tsi_AF_LG_Vi_Re3_toTsi"
)], genes=rawdata_Tcm_longest_iso[,1:1])

y_LG_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c(
"Tpa_SF_LG_Md_Re1_toTge","Tpa_SF_LG_Md_Re2_toTge","Tpa_SF_LG_Md_Re3_toTge",
"Tpa_SM_LG_Md_Re1_toTge","Tpa_SM_LG_Md_Re2_toTge","Tpa_SM_LG_Md_Re3_toTge",
"Tge_AF_LG_Vi_Re1_toTge","Tge_AF_LG_Vi_Re2_toTge","Tge_AF_LG_Vi_Re3_toTge"
)], genes=rawdata_Tpa_longest_iso[,1:1])

y_LG_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c(
"Tps_SF_LG_Md_Re1_toTdi","Tps_SF_LG_Md_Re2_toTdi","Tps_SF_LG_Md_Re3_toTdi",
"Tps_SM_LG_Md_Re1_toTdi","Tps_SM_LG_Md_Re2_toTdi","Tps_SM_LG_Md_Re3_toTdi",
"Tdi_AF_LG_Vi_Re1_toTdi","Tdi_AF_LG_Vi_Re2_toTdi","Tdi_AF_LG_Vi_Re3_toTdi"
)], genes=rawdata_Tps_longest_iso[,1:1])
...
## for SB
y_WB_SB_longest_iso_Tbi_UF <- DGEList(counts=rawdata_Tbi_longest_iso[,c("Tbi_SF_WB_Md_Re1_toTte","Tbi_SF_WB_Md_Re2_toTte","Tbi_SF_WB_Md_Re3_toTte","Tbi_SM_WB_Md_Re1_toTte","Tbi_SM_WB_Md_Re2_toTte","Tbi_SM_WB_Md_Re3_toTte")], genes=rawdata_Tbi_longest_iso[,1:1])
y_WB_SB_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c("Tce_SF_WB_Md_Re1_toTms","Tce_SF_WB_Md_Re2_toTms","Tce_SF_WB_Md_Re3_toTms","Tce_SM_WB_Md_Re1_toTms","Tce_SM_WB_Md_Re2_toTms","Tce_SM_WB_Md_Re3_toTms")], genes=rawdata_Tce_longest_iso[,1:1])
y_WB_SB_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c("Tcm_SF_WB_Md_Re1_toTsi","Tcm_SF_WB_Md_Re2_toTsi","Tcm_SF_WB_Md_Re3_toTsi","Tcm_SM_WB_Md_Re1_toTsi","Tcm_SM_WB_Md_Re2_toTsi","Tcm_SM_WB_Md_Re3_toTsi")], genes=rawdata_Tcm_longest_iso[,1:1])
y_WB_SB_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c("Tpa_SF_WB_Md_Re1_toTge","Tpa_SF_WB_Md_Re2_toTge","Tpa_SF_WB_Md_Re3_toTge","Tpa_SM_WB_Md_Re1_toTge","Tpa_SM_WB_Md_Re2_toTge","Tpa_SM_WB_Md_Re3_toTge")], genes=rawdata_Tpa_longest_iso[,1:1])
y_WB_SB_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c("Tps_SF_WB_Md_Re1_toTdi","Tps_SF_WB_Md_Re2_toTdi","Tps_SF_WB_Md_Re3_toTdi","Tps_SM_WB_Md_Re1_toTdi","Tps_SM_WB_Md_Re2_toTdi","Tps_SM_WB_Md_Re3_toTdi")], genes=rawdata_Tps_longest_iso[,1:1])

## for sex-asex
y_WB_SA_longest_iso_Tbi_UF <- DGEList(counts=rawdata_Tbi_longest_iso[,c("Tbi_SF_WB_Md_Re1_toTte","Tbi_SF_WB_Md_Re2_toTte","Tbi_SF_WB_Md_Re3_toTte","Tte_AF_WB_Vi_Re1_toTte","Tte_AF_WB_Vi_Re2_toTte","Tte_AF_WB_Vi_Re3_toTte")], genes=rawdata_Tbi_longest_iso[,1:1])
y_WB_SA_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c("Tce_SF_WB_Md_Re1_toTms","Tce_SF_WB_Md_Re2_toTms","Tce_SF_WB_Md_Re3_toTms","Tms_AF_WB_Vi_Re1_toTms","Tms_AF_WB_Vi_Re2_toTms","Tms_AF_WB_Vi_Re3_toTms")], genes=rawdata_Tce_longest_iso[,1:1])
y_WB_SA_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c("Tcm_SF_WB_Md_Re1_toTsi","Tcm_SF_WB_Md_Re2_toTsi","Tcm_SF_WB_Md_Re3_toTsi","Tsi_AF_WB_Vi_Re1_toTsi","Tsi_AF_WB_Vi_Re2_toTsi","Tsi_AF_WB_Vi_Re3_toTsi")], genes=rawdata_Tcm_longest_iso[,1:1])
y_WB_SA_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c("Tpa_SF_WB_Md_Re1_toTge","Tpa_SF_WB_Md_Re2_toTge","Tpa_SF_WB_Md_Re3_toTge","Tge_AF_WB_Vi_Re1_toTge","Tge_AF_WB_Vi_Re2_toTge","Tge_AF_WB_Vi_Re3_toTge")], genes=rawdata_Tpa_longest_iso[,1:1])
y_WB_SA_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c("Tps_SF_WB_Md_Re1_toTdi","Tps_SF_WB_Md_Re2_toTdi","Tps_SF_WB_Md_Re3_toTdi","Tdi_AF_WB_Vi_Re1_toTdi","Tdi_AF_WB_Vi_Re2_toTdi","Tdi_AF_WB_Vi_Re3_toTdi")], genes=rawdata_Tps_longest_iso[,1:1])

#### RT

## for SB
y_RT_SB_longest_iso_Tbi_UF <- DGEList(counts=rawdata_Tbi_longest_iso[,c("Tbi_SF_RT_Md_Re1_toTte","Tbi_SF_RT_Md_Re2_toTte","Tbi_SF_RT_Md_Re3_toTte","Tbi_SM_RT_Md_Re1_toTte","Tbi_SM_RT_Md_Re2_toTte","Tbi_SM_RT_Md_Re3_toTte")], genes=rawdata_Tbi_longest_iso[,1:1])
y_RT_SB_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c("Tce_SF_RT_Md_Re1_toTms","Tce_SF_RT_Md_Re2_toTms","Tce_SF_RT_Md_Re3_toTms","Tce_SM_RT_Md_Re1_toTms","Tce_SM_RT_Md_Re2_toTms","Tce_SM_RT_Md_Re3_toTms")], genes=rawdata_Tce_longest_iso[,1:1])
y_RT_SB_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c("Tcm_SF_RT_Md_Re1_toTsi","Tcm_SF_RT_Md_Re2_toTsi","Tcm_SF_RT_Md_Re3_toTsi","Tcm_SM_RT_Md_Re1_toTsi","Tcm_SM_RT_Md_Re2_toTsi","Tcm_SM_RT_Md_Re3_toTsi")], genes=rawdata_Tcm_longest_iso[,1:1])
y_RT_SB_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c("Tpa_SF_RT_Md_Re1_toTge","Tpa_SF_RT_Md_Re2_toTge","Tpa_SF_RT_Md_Re3_toTge","Tpa_SM_RT_Md_Re1_toTge","Tpa_SM_RT_Md_Re2_toTge","Tpa_SM_RT_Md_Re3_toTge")], genes=rawdata_Tpa_longest_iso[,1:1])
y_RT_SB_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c("Tps_SF_RT_Md_Re1_toTdi","Tps_SF_RT_Md_Re2_toTdi","Tps_SF_RT_Md_Re3_toTdi","Tps_SM_RT_Md_Re1_toTdi","Tps_SM_RT_Md_Re2_toTdi","Tps_SM_RT_Md_Re3_toTdi")], genes=rawdata_Tps_longest_iso[,1:1])

## for sex-asex
y_RT_SA_longest_iso_Tbi_UF <- DGEList(counts=rawdata_Tbi_longest_iso[,c("Tbi_SF_RT_Md_Re1_toTte","Tbi_SF_RT_Md_Re2_toTte","Tbi_SF_RT_Md_Re3_toTte","Tte_AF_RT_Vi_Re1_toTte","Tte_AF_RT_Vi_Re2_toTte","Tte_AF_RT_Vi_Re3_toTte")], genes=rawdata_Tbi_longest_iso[,1:1])
y_RT_SA_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c("Tce_SF_RT_Md_Re1_toTms","Tce_SF_RT_Md_Re2_toTms","Tce_SF_RT_Md_Re3_toTms","Tms_AF_RT_Vi_Re1_toTms","Tms_AF_RT_Vi_Re2_toTms","Tms_AF_RT_Vi_Re3_toTms")], genes=rawdata_Tce_longest_iso[,1:1])
y_RT_SA_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c("Tcm_SF_RT_Md_Re1_toTsi","Tcm_SF_RT_Md_Re2_toTsi","Tcm_SF_RT_Md_Re3_toTsi","Tsi_AF_RT_Vi_Re1_toTsi","Tsi_AF_RT_Vi_Re2_toTsi","Tsi_AF_RT_Vi_Re3_toTsi")], genes=rawdata_Tcm_longest_iso[,1:1])
y_RT_SA_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c("Tpa_SF_RT_Md_Re1_toTge","Tpa_SF_RT_Md_Re2_toTge","Tpa_SF_RT_Md_Re3_toTge","Tge_AF_RT_Vi_Re1_toTge","Tge_AF_RT_Vi_Re2_toTge","Tge_AF_RT_Vi_Re3_toTge")], genes=rawdata_Tpa_longest_iso[,1:1])
y_RT_SA_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c("Tps_SF_RT_Md_Re1_toTdi","Tps_SF_RT_Md_Re2_toTdi","Tps_SF_RT_Md_Re3_toTdi","Tdi_AF_RT_Vi_Re1_toTdi","Tdi_AF_RT_Vi_Re2_toTdi","Tdi_AF_RT_Vi_Re3_toTdi")], genes=rawdata_Tps_longest_iso[,1:1])


#### LG

## for SB
y_LG_SB_longest_iso_Tbi_UF <- DGEList(counts=rawdata_Tbi_longest_iso[,c("Tbi_SF_LG_Md_Re1_toTte","Tbi_SF_LG_Md_Re2_toTte","Tbi_SF_LG_Md_Re3_toTte","Tbi_SM_LG_Md_Re1_toTte","Tbi_SM_LG_Md_Re2_toTte","Tbi_SM_LG_Md_Re3_toTte")], genes=rawdata_Tbi_longest_iso[,1:1])
y_LG_SB_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c("Tce_SF_LG_Md_Re1_toTms","Tce_SF_LG_Md_Re2_toTms","Tce_SF_LG_Md_Re3_toTms","Tce_SM_LG_Md_Re1_toTms","Tce_SM_LG_Md_Re2_toTms","Tce_SM_LG_Md_Re3_toTms")], genes=rawdata_Tce_longest_iso[,1:1])
y_LG_SB_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c("Tcm_SF_LG_Md_Re1_toTsi","Tcm_SF_LG_Md_Re2_toTsi","Tcm_SF_LG_Md_Re3_toTsi","Tcm_SM_LG_Md_Re1_toTsi","Tcm_SM_LG_Md_Re2_toTsi","Tcm_SM_LG_Md_Re3_toTsi")], genes=rawdata_Tcm_longest_iso[,1:1])
y_LG_SB_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c("Tpa_SF_LG_Md_Re1_toTge","Tpa_SF_LG_Md_Re2_toTge","Tpa_SF_LG_Md_Re3_toTge","Tpa_SM_LG_Md_Re1_toTge","Tpa_SM_LG_Md_Re2_toTge","Tpa_SM_LG_Md_Re3_toTge")], genes=rawdata_Tpa_longest_iso[,1:1])
y_LG_SB_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c("Tps_SF_LG_Md_Re1_toTdi","Tps_SF_LG_Md_Re2_toTdi","Tps_SF_LG_Md_Re3_toTdi","Tps_SM_LG_Md_Re1_toTdi","Tps_SM_LG_Md_Re2_toTdi","Tps_SM_LG_Md_Re3_toTdi")], genes=rawdata_Tps_longest_iso[,1:1])

## for sex-asex
y_LG_SA_longest_iso_Tbi_UF <- DGEList(counts=rawdata_Tbi_longest_iso[,c("Tbi_SF_LG_Md_Re1_toTte","Tbi_SF_LG_Md_Re2_toTte","Tbi_SF_LG_Md_Re3_toTte","Tte_AF_LG_Vi_Re1_toTte","Tte_AF_LG_Vi_Re2_toTte","Tte_AF_LG_Vi_Re3_toTte")], genes=rawdata_Tbi_longest_iso[,1:1])
y_LG_SA_longest_iso_Tce_UF <- DGEList(counts=rawdata_Tce_longest_iso[,c("Tce_SF_LG_Md_Re1_toTms","Tce_SF_LG_Md_Re2_toTms","Tce_SF_LG_Md_Re3_toTms","Tms_AF_LG_Vi_Re1_toTms","Tms_AF_LG_Vi_Re2_toTms","Tms_AF_LG_Vi_Re3_toTms")], genes=rawdata_Tce_longest_iso[,1:1])
y_LG_SA_longest_iso_Tcm_UF <- DGEList(counts=rawdata_Tcm_longest_iso[,c("Tcm_SF_LG_Md_Re1_toTsi","Tcm_SF_LG_Md_Re2_toTsi","Tcm_SF_LG_Md_Re3_toTsi","Tsi_AF_LG_Vi_Re1_toTsi","Tsi_AF_LG_Vi_Re2_toTsi","Tsi_AF_LG_Vi_Re3_toTsi")], genes=rawdata_Tcm_longest_iso[,1:1])
y_LG_SA_longest_iso_Tpa_UF <- DGEList(counts=rawdata_Tpa_longest_iso[,c("Tpa_SF_LG_Md_Re1_toTge","Tpa_SF_LG_Md_Re2_toTge","Tpa_SF_LG_Md_Re3_toTge","Tge_AF_LG_Vi_Re1_toTge","Tge_AF_LG_Vi_Re2_toTge","Tge_AF_LG_Vi_Re3_toTge")], genes=rawdata_Tpa_longest_iso[,1:1])
y_LG_SA_longest_iso_Tps_UF <- DGEList(counts=rawdata_Tps_longest_iso[,c("Tps_SF_LG_Md_Re1_toTdi","Tps_SF_LG_Md_Re2_toTdi","Tps_SF_LG_Md_Re3_toTdi","Tdi_AF_LG_Vi_Re1_toTdi","Tdi_AF_LG_Vi_Re2_toTdi","Tdi_AF_LG_Vi_Re3_toTdi")], genes=rawdata_Tps_longest_iso[,1:1])
...
####### output session info
print (sessionInfo())
writeLines(capture.output(sessionInfo()), "sex_bias_edgeR_asexual_ref.R_sessionInfo.txt")
