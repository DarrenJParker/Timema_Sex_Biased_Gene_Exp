...
head(dat_Tps_WB_RBBH_SB_asex)



################################################ ######################## ######################## 
######################## get excluded genes (ones with low expression in asexual females)
...
N_SB_Genes_kept_excluded <- function(df, df_name, sp, tiss){
	...
	df_excl$sp <- rep(sp, length(df_excl[,1]))   
...
excl_df_Tbi_WB <- N_SB_Genes_kept_excluded(dat_Tbi_WB_RBBH_SB_asex, "dat_Tbi_WB_RBBH_SB_asex", "Tbi", "WB")$excl_df
excl_df_Tce_WB <- N_SB_Genes_kept_excluded(dat_Tce_WB_RBBH_SB_asex, "dat_Tce_WB_RBBH_SB_asex", "Tce", "WB")$excl_df
excl_df_Tcm_WB <- N_SB_Genes_kept_excluded(dat_Tcm_WB_RBBH_SB_asex, "dat_Tcm_WB_RBBH_SB_asex", "Tcm", "WB")$excl_df
excl_df_Tpa_WB <- N_SB_Genes_kept_excluded(dat_Tpa_WB_RBBH_SB_asex, "dat_Tpa_WB_RBBH_SB_asex", "Tpa", "WB")$excl_df
excl_df_Tps_WB <- N_SB_Genes_kept_excluded(dat_Tps_WB_RBBH_SB_asex, "dat_Tps_WB_RBBH_SB_asex", "Tps", "WB")$excl_df

excl_df_Tbi_RT <- N_SB_Genes_kept_excluded(dat_Tbi_RT_RBBH_SB_asex, "dat_Tbi_RT_RBBH_SB_asex", "Tbi", "RT")$excl_df
excl_df_Tce_RT <- N_SB_Genes_kept_excluded(dat_Tce_RT_RBBH_SB_asex, "dat_Tce_RT_RBBH_SB_asex", "Tce", "RT")$excl_df
excl_df_Tcm_RT <- N_SB_Genes_kept_excluded(dat_Tcm_RT_RBBH_SB_asex, "dat_Tcm_RT_RBBH_SB_asex", "Tcm", "RT")$excl_df
excl_df_Tpa_RT <- N_SB_Genes_kept_excluded(dat_Tpa_RT_RBBH_SB_asex, "dat_Tpa_RT_RBBH_SB_asex", "Tpa", "RT")$excl_df
excl_df_Tps_RT <- N_SB_Genes_kept_excluded(dat_Tps_RT_RBBH_SB_asex, "dat_Tps_RT_RBBH_SB_asex", "Tps", "RT")$excl_df

excl_df_Tbi_LG <- N_SB_Genes_kept_excluded(dat_Tbi_LG_RBBH_SB_asex, "dat_Tbi_LG_RBBH_SB_asex", "Tbi", "LG")$excl_df
excl_df_Tce_LG <- N_SB_Genes_kept_excluded(dat_Tce_LG_RBBH_SB_asex, "dat_Tce_LG_RBBH_SB_asex", "Tce", "LG")$excl_df
excl_df_Tcm_LG <- N_SB_Genes_kept_excluded(dat_Tcm_LG_RBBH_SB_asex, "dat_Tcm_LG_RBBH_SB_asex", "Tcm", "LG")$excl_df
excl_df_Tpa_LG <- N_SB_Genes_kept_excluded(dat_Tpa_LG_RBBH_SB_asex, "dat_Tpa_LG_RBBH_SB_asex", "Tpa", "LG")$excl_df
excl_df_Tps_LG <- N_SB_Genes_kept_excluded(dat_Tps_LG_RBBH_SB_asex, "dat_Tps_LG_RBBH_SB_asex", "Tps", "LG")$excl_df


### N kept

N_kept_excl_df <- rbind(
N_SB_Genes_kept_excluded(dat_Tbi_WB_RBBH_SB_asex, "dat_Tbi_WB_RBBH_SB_asex", "Tbi", "WB")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tce_WB_RBBH_SB_asex, "dat_Tce_WB_RBBH_SB_asex", "Tce", "WB")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tcm_WB_RBBH_SB_asex, "dat_Tcm_WB_RBBH_SB_asex", "Tcm", "WB")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tpa_WB_RBBH_SB_asex, "dat_Tpa_WB_RBBH_SB_asex", "Tpa", "WB")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tps_WB_RBBH_SB_asex, "dat_Tps_WB_RBBH_SB_asex", "Tps", "WB")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tbi_RT_RBBH_SB_asex, "dat_Tbi_RT_RBBH_SB_asex", "Tbi", "RT")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tce_RT_RBBH_SB_asex, "dat_Tce_RT_RBBH_SB_asex", "Tce", "RT")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tcm_RT_RBBH_SB_asex, "dat_Tcm_RT_RBBH_SB_asex", "Tcm", "RT")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tpa_RT_RBBH_SB_asex, "dat_Tpa_RT_RBBH_SB_asex", "Tpa", "RT")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tps_RT_RBBH_SB_asex, "dat_Tps_RT_RBBH_SB_asex", "Tps", "RT")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tbi_LG_RBBH_SB_asex, "dat_Tbi_LG_RBBH_SB_asex", "Tbi", "LG")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tce_LG_RBBH_SB_asex, "dat_Tce_LG_RBBH_SB_asex", "Tce", "LG")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tcm_LG_RBBH_SB_asex, "dat_Tcm_LG_RBBH_SB_asex", "Tcm", "LG")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tpa_LG_RBBH_SB_asex, "dat_Tpa_LG_RBBH_SB_asex", "Tpa", "LG")$out_df_2,
N_SB_Genes_kept_excluded(dat_Tps_LG_RBBH_SB_asex, "dat_Tps_LG_RBBH_SB_asex", "Tps", "LG")$out_df_2)


### N kept by SB 
N_kept_excl_SB_df <- rbind(
N_SB_Genes_kept_excluded(dat_Tbi_WB_RBBH_SB_asex, "dat_Tbi_WB_RBBH_SB_asex", "Tbi", "WB")$out_df,
N_SB_Genes_kept_excluded(dat_Tce_WB_RBBH_SB_asex, "dat_Tce_WB_RBBH_SB_asex", "Tce", "WB")$out_df,
N_SB_Genes_kept_excluded(dat_Tcm_WB_RBBH_SB_asex, "dat_Tcm_WB_RBBH_SB_asex", "Tcm", "WB")$out_df,
N_SB_Genes_kept_excluded(dat_Tpa_WB_RBBH_SB_asex, "dat_Tpa_WB_RBBH_SB_asex", "Tpa", "WB")$out_df,
N_SB_Genes_kept_excluded(dat_Tps_WB_RBBH_SB_asex, "dat_Tps_WB_RBBH_SB_asex", "Tps", "WB")$out_df,
N_SB_Genes_kept_excluded(dat_Tbi_RT_RBBH_SB_asex, "dat_Tbi_RT_RBBH_SB_asex", "Tbi", "RT")$out_df,
N_SB_Genes_kept_excluded(dat_Tce_RT_RBBH_SB_asex, "dat_Tce_RT_RBBH_SB_asex", "Tce", "RT")$out_df,
N_SB_Genes_kept_excluded(dat_Tcm_RT_RBBH_SB_asex, "dat_Tcm_RT_RBBH_SB_asex", "Tcm", "RT")$out_df,
N_SB_Genes_kept_excluded(dat_Tpa_RT_RBBH_SB_asex, "dat_Tpa_RT_RBBH_SB_asex", "Tpa", "RT")$out_df,
N_SB_Genes_kept_excluded(dat_Tps_RT_RBBH_SB_asex, "dat_Tps_RT_RBBH_SB_asex", "Tps", "RT")$out_df,
N_SB_Genes_kept_excluded(dat_Tbi_LG_RBBH_SB_asex, "dat_Tbi_LG_RBBH_SB_asex", "Tbi", "LG")$out_df,
N_SB_Genes_kept_excluded(dat_Tce_LG_RBBH_SB_asex, "dat_Tce_LG_RBBH_SB_asex", "Tce", "LG")$out_df,
N_SB_Genes_kept_excluded(dat_Tcm_LG_RBBH_SB_asex, "dat_Tcm_LG_RBBH_SB_asex", "Tcm", "LG")$out_df,
N_SB_Genes_kept_excluded(dat_Tpa_LG_RBBH_SB_asex, "dat_Tpa_LG_RBBH_SB_asex", "Tpa", "LG")$out_df,
N_SB_Genes_kept_excluded(dat_Tps_LG_RBBH_SB_asex, "dat_Tps_LG_RBBH_SB_asex", "Tps", "LG")$out_df)
...
head(N_kept_excl_SB_df)
### fishers test

N_kept_excl_SB_FT_df <- rbind(
N_SB_Genes_kept_excluded(dat_Tbi_WB_RBBH_SB_asex, "dat_Tbi_WB_RBBH_SB_asex", "Tbi", "WB")$out_df3,
N_SB_Genes_kept_excluded(dat_Tce_WB_RBBH_SB_asex, "dat_Tce_WB_RBBH_SB_asex", "Tce", "WB")$out_df3,
N_SB_Genes_kept_excluded(dat_Tcm_WB_RBBH_SB_asex, "dat_Tcm_WB_RBBH_SB_asex", "Tcm", "WB")$out_df3,
N_SB_Genes_kept_excluded(dat_Tpa_WB_RBBH_SB_asex, "dat_Tpa_WB_RBBH_SB_asex", "Tpa", "WB")$out_df3,
N_SB_Genes_kept_excluded(dat_Tps_WB_RBBH_SB_asex, "dat_Tps_WB_RBBH_SB_asex", "Tps", "WB")$out_df3,
N_SB_Genes_kept_excluded(dat_Tbi_RT_RBBH_SB_asex, "dat_Tbi_RT_RBBH_SB_asex", "Tbi", "RT")$out_df3,
N_SB_Genes_kept_excluded(dat_Tce_RT_RBBH_SB_asex, "dat_Tce_RT_RBBH_SB_asex", "Tce", "RT")$out_df3,
N_SB_Genes_kept_excluded(dat_Tcm_RT_RBBH_SB_asex, "dat_Tcm_RT_RBBH_SB_asex", "Tcm", "RT")$out_df3,
N_SB_Genes_kept_excluded(dat_Tpa_RT_RBBH_SB_asex, "dat_Tpa_RT_RBBH_SB_asex", "Tpa", "RT")$out_df3,
N_SB_Genes_kept_excluded(dat_Tps_RT_RBBH_SB_asex, "dat_Tps_RT_RBBH_SB_asex", "Tps", "RT")$out_df3,
N_SB_Genes_kept_excluded(dat_Tbi_LG_RBBH_SB_asex, "dat_Tbi_LG_RBBH_SB_asex", "Tbi", "LG")$out_df3,
N_SB_Genes_kept_excluded(dat_Tce_LG_RBBH_SB_asex, "dat_Tce_LG_RBBH_SB_asex", "Tce", "LG")$out_df3,
N_SB_Genes_kept_excluded(dat_Tcm_LG_RBBH_SB_asex, "dat_Tcm_LG_RBBH_SB_asex", "Tcm", "LG")$out_df3,
N_SB_Genes_kept_excluded(dat_Tpa_LG_RBBH_SB_asex, "dat_Tpa_LG_RBBH_SB_asex", "Tpa", "LG")$out_df3,
N_SB_Genes_kept_excluded(dat_Tps_LG_RBBH_SB_asex, "dat_Tps_LG_RBBH_SB_asex", "Tps", "LG")$out_df3)
...
make_long_table = function(dat_Tbi,dat_Tce,dat_Tcm,dat_Tpa,dat_Tps,tiss){
	...
	df_t1 = as.data.frame(cbind(
		...
		as.character(eval(parse(text=paste(dat_Tbi,'$genename', sep='')))))) 
	df_t1$sp     = rep(sp_u, length(df_t1[,1]))
	df_t1$group  = paste(df_t1$sp, df_t1$V2, sep = "_")
	df_t1$group2 = paste(df_t1$sp, df_t1$V3, sep = "_")
	df_t1$log2FC_SB = eval(parse(text=paste(dat_Tbi,'$', sp_u, '_' ,tiss,'_log2FC_SB',sep='')))
	...
	df_t2 = as.data.frame(cbind(
		...
		as.character(eval(parse(text=paste(dat_Tce,'$genename',sep=''))))))  
	df_t2$sp     = rep(sp_u, length(df_t2[,1]))
	df_t2$group  = paste(df_t2$sp, df_t2$V2, sep = "_")
	df_t2$group2 = paste(df_t2$sp, df_t2$V3, sep = "_")
	df_t2$log2FC_SB = eval(parse(text=paste(dat_Tce,'$', sp_u, '_' ,tiss,'_log2FC_SB',sep='')))
	...
	df_t3 = as.data.frame(cbind(
		...
		as.character(eval(parse(text=paste(dat_Tcm,'$genename',sep=''))))))  
	df_t3$sp     = rep(sp_u, length(df_t3[,1]))
	df_t3$group  = paste(df_t3$sp, df_t3$V2, sep = "_")
	df_t3$group2 = paste(df_t3$sp, df_t3$V3, sep = "_")
	df_t3$log2FC_SB = eval(parse(text=paste(dat_Tcm,'$', sp_u, '_' ,tiss,'_log2FC_SB',sep='')))
	...
	df_t4 = as.data.frame(cbind(
		...
		as.character(eval(parse(text=paste(dat_Tpa,'$genename',sep=''))))))  
	df_t4$sp     = rep(sp_u, length(df_t4[,1]))
	df_t4$group  = paste(df_t4$sp, df_t4$V2, sep = "_")
	df_t4$group2 = paste(df_t4$sp, df_t4$V3, sep = "_")
	df_t4$log2FC_SB = eval(parse(text=paste(dat_Tpa,'$', sp_u, '_' ,tiss,'_log2FC_SB',sep='')))
	...
	df_t5 = as.data.frame(cbind(
		...
		as.character(eval(parse(text=paste(dat_Tps,'$genename',sep=''))))))   
	df_t5$sp     = rep(sp_u, length(df_t5[,1]))
	df_t5$group  = paste(df_t5$sp, df_t5$V2, sep = "_")
	df_t5$group2 = paste(df_t5$sp, df_t5$V3, sep = "_")
	df_t5$log2FC_SB = eval(parse(text=paste(dat_Tps,'$', sp_u, '_' ,tiss,'_log2FC_SB',sep='')))
		

	df_t = rbind(df_t1,df_t2,df_t3,df_t4,df_t5)
	colnames(df_t) <- c("log2FC_SA", "sexbias", "sexbias2", "genename", "sp", "SBgroup", "SBgroup2", "log2FC_SB")
...
dat_ALL_WB_RBBH_SB_asex_long$sp_genename <- paste(dat_ALL_WB_RBBH_SB_asex_long$sp, dat_ALL_WB_RBBH_SB_asex_long$genename, sep = "_")
dat_ALL_RT_RBBH_SB_asex_long$sp_genename <- paste(dat_ALL_RT_RBBH_SB_asex_long$sp, dat_ALL_RT_RBBH_SB_asex_long$genename, sep = "_")
dat_ALL_LG_RBBH_SB_asex_long$sp_genename <- paste(dat_ALL_LG_RBBH_SB_asex_long$sp, dat_ALL_LG_RBBH_SB_asex_long$genename, sep = "_")

head(dat_ALL_WB_RBBH_SB_asex_long)
...
dat_ALL_WBRTLG_RBBH_SB_asex_long_c_2 <- rbind(dat_ALL_WBRTLG_RBBH_SB_asex_long_c, c(NA,"Unbiased","Unbiased",NA,NA,NA,NA,NA,NA,NA,"WB", NA,NA,NA,NA,NA, "skip_WB"))
dat_ALL_WBRTLG_RBBH_SB_asex_long_c_2 <- rbind(dat_ALL_WBRTLG_RBBH_SB_asex_long_c_2, c(NA,"Unbiased","Unbiased",NA,NA,NA,NA,NA,NA,NA,"RT", NA,NA,NA,NA,NA, "skip_RT"))
...
tail(dat_ALL_WBRTLG_RBBH_SB_asex_long_c_2)

##### plot boxplots

### without FC cutoff
WBRTLG_SA_box_s1 <- ggplot(dat_ALL_WBRTLG_RBBH_SB_asex_long_c_2, aes(sp_tiss2_ord, log2FC_SA)) + 
	theme_classic() +
...
### with FC cutoff
WBRTLG_SA_box_s2 <- ggplot(dat_ALL_WBRTLG_RBBH_SB_asex_long_c_2, aes(sp_tiss2_ord, log2FC_SA)) + 
	theme_classic() +
...
pdf(paste("Sex_asex_RBBH_LG_FC_boxplot_s1_FDR005.pdf",sep = ""), width = 8.2, height = 8)
WBRTLG_SA_box_s1
dev.off()
getwd() ## wh

pdf(paste("Sex_asex_RBBH_LG_FC_boxplot_s2_FDR005FC2.pdf",sep = ""), width = 8.2, height = 8)
WBRTLG_SA_box_s2
dev.off()
getwd() ## wh
...
####### output session info
print (sessionInfo())
writeLines(capture.output(sessionInfo()), "sex_bias_plotsetc_sessionInfo.txt")
